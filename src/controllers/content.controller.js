...
//     /**
//      * @description Crea una instancia del controlador de contenido
...
//     // }
//     constructor(contentService, fileService) {
...
//         //     const content = await LandingPageContent.findOne().sort({ createdAt: -1 });

//         //     if (!content) {
//         //         // Crear documento inicial si no existe
//         //         const initialContent = new LandingPageContent({
//         //             welcomeSections: [],
//         //             faqs: [],
//         //             footerText: '',
//         //             carouselItems: [],
...
//         //     next(error);
//         // }
//         // const content = await this.landingContentService.getContent(req, res, next);
//         try {
//             await this.contentService.getContent(req, res, next);
//         } catch (error) {
//             next(error);
//         }
//         // res.json({ success: true, data: content });
...
//         //     let content = await LandingPageContent.findOne().sort({ createdAt: -1 });
...
//         try {
//             await this.contentService.updateContent(req, res, next);
//         } catch (error) {
//             next(error);
//         }
//     };
...
//         try {
//             this.contentService.uploadCarouselMedia(req, res, next);
//         } catch (error) {
//             next(error);
//         }
//     };
...
//         try {
//             this.contentService.uploadSubsectionImage(req, res, next);
//         } catch (error) {
//             next(error);
//         }
//     };
...
//         try {
//             this.contentService.deleteCarouselItem(req, res, next);
//         } catch (error) {
//             next(error);
//         }
//     };
...
//         //             sectionIndex,
//         //             subsectionIndex,
//         //             subsection: { ...subsection.toObject({ getters: true }), _id: undefined }
//         //         }
//         //     });
...
//         try {
//             this.contentService.deleteSubsectionImage(req, res, next);
//         } catch (error) {
//             next(error);
//         }
//     };
...
export default class ContentController {
    /**
     * @description Crea una instancia del controlador de contenido
     * @param {ModelContent} ModelContent - Modelo de contenido
     * @param {FileService} fileService - Servicio de envío de archivos
     * @param {Logger} logger - Instancia de logger
     * @example
     * ModelContent import from('../models/content.model');
     * const fileService = new FileService();
     * logger import from ('./config/logger.js');
     * const contentController = new ContentController(ModelContent, fileService, logger);
     */
    constructor(ModelContent, fileService, logger) {
    ...
    getContent = async (req, res, next) => {
        try {
            ...
            if (!content) {
                // Crear documento inicial si no existe
                const initialContent = new this.ModelContent(
                    this.ModelContent.modelName === 'LandingPageContent'
                        ? {
                            welcomeSections: [],
                            faqs: [],
                            footerText: '',
    ...
    updateContent = async (req, res, next) => {
        try {
            ...
            if (!content) {
                ...
                if (this.ModelContent.modelName === 'LandingPageContent') {
                    if (updateData.faqs) content.faqs = updateData.faqs;
                    if (updateData.footerText !== undefined) content.footerText = updateData.footerText;
                }
